...
public class Shiyan2Activity extends AppCompatActivity {
    EditText etSearch;
    Button btnSearch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shiyan2);
    ...
    private void showToastInThread(final String string) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(Shiyan2Activity.this, string, Toast.LENGTH_LONG).show();
            }
        });
    }
